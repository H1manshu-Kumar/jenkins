...
![Jenkins Pipeline Stage View](screenshots/02-jenkins-pipeline-stage-view.png)
...
![Setup Stage Output](screenshots/03-setup-stage-output.png)
...
![Lint Stage Output](screenshots/04-lint-stage-output.png)
...
![Test Stage Output](screenshots/05-test-stage-output.png)

<!-- SCREENSHOT: Jenkins Test Results page (JUnit report) showing passed/failed/skipped counts -->
![JUnit Test Report](screenshots/06-junit-test-report.png)
...
![Install Docker CLI Output](screenshots/07-install-docker-cli-output.png)
...
![Docker Build Output](screenshots/08-docker-build-output.png)

<!-- SCREENSHOT: docker images command output showing the newly built image with both version tag and latest tag -->
![Docker Images List](screenshots/09-docker-images-list.png)
...
![Docker Login Output](screenshots/10-docker-login-output.png)
...
![Docker Push Versioned Tag](screenshots/11a-docker-push-versioned-tag.png)

<!-- SCREENSHOT: Jenkins console output showing push progress for latest tag -->
![Docker Push Latest Tag](screenshots/11b-docker-push-latest-tag.png)
...
![Validate Image Smoke Test](screenshots/12-validate-image-smoke-test.png)

---

### 🐳 DockerHub — Image Published Successfully

<!-- SCREENSHOT: DockerHub repository page (hub.docker.com/r/username/devpulse) showing the repo with push activity -->
![DockerHub Repository](screenshots/13-dockerhub-repo-page.png)

<!-- SCREENSHOT: DockerHub Tags tab showing both versioned tag (e.g. 1.0.5) and latest tag with size and last pushed time -->
![DockerHub Tags](screenshots/14-dockerhub-repo-tags.png)
...
![Post Build Cleanup](screenshots/15-post-build-cleanup.png)

<!-- SCREENSHOT: Jenkins build history sidebar showing green build #N with build duration -->
![Jenkins Build History](screenshots/16-jenkins-build-history.png)
...
└── screenshots/        ← Pipeline execution screenshots
    ├── 01-jenkins-dockerhub-credentials.png
    ├── 02-jenkins-pipeline-stage-view.png
    ├── 03-setup-stage-output.png
    ├── 04-lint-stage-output.png
    ├── 05-test-stage-output.png
    ├── 06-junit-test-report.png
    ├── 07-install-docker-cli-output.png
    ├── 08-docker-build-output.png
    ├── 09-docker-images-list.png
    ├── 10-docker-login-output.png
    ├── 11a-docker-push-versioned-tag.png
    ├── 11b-docker-push-latest-tag.png
    ├── 12-validate-image-smoke-test.png
    ├── 13-dockerhub-repo-page.png
    ├── 14-dockerhub-repo-tags.png
    ├── 15-post-build-cleanup.png
    └── 16-jenkins-build-history.png
```
